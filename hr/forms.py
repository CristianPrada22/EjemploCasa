...
class AddRecruitmentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['requester'].widget.attrs.update({'class': 'form-control'})
        self.fields['dateOfRequest'].widget.attrs.update({'class': 'form-control'})
        self.fields['departament'].widget.attrs.update({'class': 'form-control'})
        self.fields['jobDescription'].widget.attrs.update({'class': 'form-control'})
        ...
        self.fields['responsabilities'].widget.attrs.update({'class': 'form-control'})
...
class SelectInitialCandidateForm(forms.Form):
    """ Form creation - SelectInitialCandidate Form """
    
    """ Options for RequisitionApproved field in the AddRecruitment Form. """
    CHANGE_IN_ADVERTISEMENT_CHOICES = [
        ('True', _('Yes')),
        ('False', 'No'),
    ]

    changeInAdverstisement = forms.ChoiceField(
        label = _('Change In Adverstisement Need?'),
        required = True, 
        widget = forms.RadioSelect,
        choices = CHANGE_IN_ADVERTISEMENT_CHOICES,
    )